...
- (void)mailComposeController:(MFMailComposeViewController*)controller didFinishWithResult:(MFMailComposeResult)result error:(NSError*)error
{
    ...
    if ([[AdMobViewController sharedAdMob] connectedToInternet]) {
        ...
        [[AdMobViewController sharedAdMob] bannerFrame:CGRectMake(0,[[UIScreen mainScreen] bounds].size.height - 140,0,0)];
    }
...
- (NSString *)messageTitle
{
    ...
    NSString *str = [NSString stringWithFormat:@"Check out %@", @"Max Fitness"];
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        ...
                        if (!applicationSellerName) {
                            if (sellerName!=nil) {
                                ...
                                [defaults setObject:sellerName forKey:@"Max Fitness"];
                            }
                        }
                    });
