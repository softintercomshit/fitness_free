...
- (void)repositionControls
{
    ...
    if (alertView.numberOfButtons > 0)
    {
        ...
        if (self.alertView.frame.size.height >=181)
        {
            self.alertView.frame = (CGRect){self.alertView.frame.origin, {self.alertView.frame.size.width, self.alertView.frame.size.height}};
        }
        else
        {
            self.alertView.frame = (CGRect){self.alertView.frame.origin, {self.alertView.frame.size.width, self.alertView.frame.size.height +40.0f}};
